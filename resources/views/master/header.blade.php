	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="pr-4 col-md d-flex topper align-items-center">
					    	<div class="mr-2 icon d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
						    <span class="text">+ 1235 2355 98</span>
					    </div>
					    <div class="pr-4 col-md d-flex topper align-items-center">
					    	<div class="mr-2 icon d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="ml-auto navbar-nav">
				...
				<li class="nav-item"><a href="PageShowDataUser-{{Auth::user()->id}}" class="nav-link">Profile</a></li>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="p-0 container-fluid">
	          <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third order-md-last img-fluid" src="{{asset('master/images/bg_1.png')}}" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">#New Arrival</span>
		          		<div class="horizontal">
				            <h1 class="mt-3 mb-4">Shoes Collection 2019</h1>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="p-0 container-fluid">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third order-md-last img-fluid" src="{{asset('master/images/bg_2.png')}}" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">#New Arrival</span>
		          		<div class="horizontal">
				            <h1 class="mt-3 mb-4">New Shoes Winter Collection</h1>
				            <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country.</p>
